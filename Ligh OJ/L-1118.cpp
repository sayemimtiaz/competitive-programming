...
int main()
{
    double A1,A2,Area,d,x1,y1,r1,r2,x2,y2;
    int i,j,kase,kas=0;
    S1(kase);
    while(kase--)
    {
     ...
     A1=2.0*acos((r1*r1+d*d-r2*r2)/(2*r1*d));
     A2=2.0*acos((r2*r2+d*d-r1*r1)/(2*r2*d));
     Area=0.5*A1*r1*r1-0.5*r1*r1*sin(A1)+0.5*A2*r2*r2-0.5*r2*r2*sin(A2);
